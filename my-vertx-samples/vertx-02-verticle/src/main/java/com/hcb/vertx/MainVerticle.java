...
public class MainVerticle extends AbstractVerticle {
    ...
    private static final String SQL_CREATE_PAGES_TABLE = "create table if not exists Pages (Id int  primary key, Name varchar(255) unique, Content text)";
    ...
    public void start(Future<Void> startFuture) throws Exception {
        ...
        final Future<Void> future = prepareDataBase().compose(v -> startHttpServer());
    ...
    private void s(String s , Integer i){
    ...
    private Future<Void> prepareDataBase() {
        ...
        final Future<Void> future = Future.factory.future();
        dbClient = JDBCClient.createShared(vertx, new JsonObject()
                .put("url", "jdbc:mysql://127.0.0.1:3306/wiki?characterEncoding=utf8&useSSL=true")
